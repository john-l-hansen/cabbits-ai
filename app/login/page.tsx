  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-lg relative z-10">
        ...
        {step === "splash" && (
          <section className="chunky-panel bg-[#f5f2eb] p-8 flex flex-col items-center justify-between text-center min-h-[500px]">
            <div className="space-y-2 mt-4">
              <div className="border-2 border-[var(--neutral-300)] bg-white px-6 py-2 rounded-full inline-block font-extrabold uppercase tracking-widest text-[var(--neutral-900)] text-sm">
                Cabbits
              </div>
              <p className="text-xs font-black text-[var(--neutral-500)] uppercase tracking-wider">A cozy learning adventure</p>
            </div>

            <div className="my-6 w-48 h-48 rounded-full border-2 border-black/10 bg-[#eae4d3] flex items-center justify-center overflow-hidden relative select-none animate-float shadow-inner p-6">
              <img 
            ...
            <div className="w-full space-y-4 max-w-sm mb-4">
              ...
              <button
                ...
                className="w-full chunky-button bg-white py-4 font-bold transition-all text-sm cursor-pointer"
              >
                Continue Adventure
              </button>
              <p className="text-[10px] text-[var(--neutral-400)] leading-relaxed pt-2 font-bold">
        ...
        {step === "returning" && (
          <section className="chunky-panel bg-[#f5f2eb] p-8 animate-scale-up">
            <button
              onClick={() => setStep("splash")}
              className="text-xs font-black text-[var(--neutral-500)] hover:text-black mb-6 inline-block cursor-pointer"
            >
              ← Back
            </button>

            <div className="text-center space-y-2 mb-8">
              <div className="border-2 border-[var(--neutral-300)] bg-white px-4 py-1.5 rounded-full inline-block font-extrabold uppercase tracking-widest text-[var(--neutral-900)] text-xs">
                Welcome Back!
              </div>
              <h2 className="text-2xl font-black text-[var(--neutral-900)]">Sign in to continue</h2>
            </div>

            <form onSubmit={handleSignIn} className="space-y-5">
              <label className="grid gap-2">
                <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Email Address</span>
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className="rounded-2xl border-2 border-black/10 bg-white/70 px-4 py-3.5 outline-none focus:border-[#4A6FA5] transition-all text-sm text-[var(--neutral-900)] font-medium shadow-inner"
              ...
              <label className="grid gap-2">
                <div className="flex justify-between items-center">
                  <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Password</span>
                  <span className="text-xs text-[var(--neutral-500)] hover:underline cursor-pointer font-bold">Forgot password?</span>
                </div>
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full rounded-2xl border-2 border-black/10 bg-white/70 px-4 py-3.5 outline-none focus:border-[#4A6FA5] transition-all text-sm text-[var(--neutral-900)] pr-12 font-medium shadow-inner"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 text-xs font-bold text-[var(--neutral-500)] hover:text-black select-none cursor-pointer"
                  >
            ...
            <div className="my-6 flex items-center justify-between gap-4">
              ...
              <span className="text-xs font-black text-[var(--neutral-400)] uppercase">or</span>
              <hr className="w-full border-black/10" />
            </div>

            <button
              onClick={handleGoogleSignIn}
              className="w-full chunky-button bg-white py-3.5 font-bold transition-all text-xs cursor-pointer flex items-center justify-center gap-2"
            >
              <span>🌐</span> Continue with Google
            </button>

            <p className="text-center text-xs text-[var(--neutral-500)] mt-8 font-semibold">
              New to Cabbits?{" "}
              <span onClick={() => {
                setError("");
                setStep("signup");
              }} className="font-black text-black underline cursor-pointer">
                Create an account
              </span>
            </p>
          </section>
        ...
        {step === "signup" && (
          <section className="chunky-panel bg-[#f5f2eb] p-8 animate-scale-up">
            ...
            <div className="text-center space-y-2 mb-8">
              ...
              <h2 className="text-2xl font-black text-[var(--neutral-900)]">Create an explorer account</h2>
            </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-5">
              ...
              <label className="grid gap-2">
                ...
                <input
                  ...
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                  className="w-full rounded-2xl border-2 border-black/10 bg-white/70 px-4 py-3.5 outline-none focus:border-[#4A6FA5] transition-all text-sm text-[var(--neutral-900)] font-medium shadow-inner"
              ...
              <label className="grid gap-2">
                <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Confirm Password</span>
                <input
                  type="password"
        ...
        {step === "creation" && (
          <section className="chunky-panel bg-[#f5f2eb] p-6 animate-scale-up max-w-2xl mx-auto">
            <div className="flex items-center justify-between mb-6">
              <button
                onClick={() => setStep("splash")}
                className="text-xs font-black text-[var(--neutral-500)] hover:text-black cursor-pointer"
              >
                ← Back
              </button>
              <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Customizer</span>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              {/* Left Column: Preview area */}
              <div className="md:col-span-2 flex flex-col items-center justify-center p-4 border-2 border-black/10 rounded-2xl bg-white/70 text-center min-h-[250px] shadow-inner">
                <h4 className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)] mb-4">Preview</h4>
                <CabbitVectorPreview earStyle={earStyle} eyeStyle={eyeStyle} furColor={furColor} />
                <p className="text-[10px] text-[var(--neutral-500)] font-bold mt-3">Updates as you customize</p>
              </div>

              {/* Right Column: Controls area */}
              <form onSubmit={handleConfirmCustomization} className="md:col-span-3 space-y-5">
                <h3 className="text-lg font-black text-[var(--neutral-900)]">Create Your Cabbit</h3>
                
                {/* Cabbit Name */}
                <label className="grid gap-1.5">
                  <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Cabbit Name</span>
                  <input
                    type="text"
                    value={name}
                    onChange={(e) => {
                    ...
                    className="rounded-xl border-2 border-black/10 bg-white/70 px-3.5 py-2.5 outline-none focus:border-[#4A6FA5] transition-all text-xs text-[var(--neutral-900)] font-medium shadow-inner"
                ...
                <div className="space-y-1.5">
                  <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Ear Style</span>
                  <div className="grid grid-cols-3 gap-2">
                    {(["floppy", "pointy", "round"] as const).map((style) => (
                      <button
                        ...
                        className={`py-2.5 text-xs font-bold uppercase tracking-wide transition-all cursor-pointer ${
                          earStyle === style
                            ? "chunky-button bg-[#4A6FA5] !text-white"
                            : "chunky-button bg-white text-[var(--neutral-700)]"
                        }`}
                      >
                        {style}
                      </button>
                ...
                {/* Eye Style */}
                <div className="space-y-1.5">
                  <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Eye Style</span>
                  <div className="grid grid-cols-3 gap-2">
                ...
                <div className="space-y-1.5">
                  <div className="flex flex-col">
                    <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Fur Accent</span>
                    <span className="text-[9px] text-[var(--neutral-400)] leading-none mt-0.5 font-bold">Applied to cheeks, ears & tail tip</span>
                  </div>
                      ...
                      return (
                        <button
                          ...
                          className={`h-8 w-8 rounded-full border-2 transition-all cursor-pointer relative ${colorHexMap[color]} ${
                            furColor === color ? "border-black scale-110 shadow-sm" : "border-black/10"
                          }`}
                          title={color}
                        >
                          {furColor === color && (
                ...
                <label className="grid gap-1.5">
                  <div className="flex flex-col">
                    <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Starting Keepsake</span>
                    <span className="text-[9px] text-[var(--neutral-400)] leading-none mt-0.5 font-bold">Describe a cosmetic item (scarf, ribbon, pin...)</span>
                  </div>
                  <input
                    type="text"
                    value={keepsake}
                ...
                <div className="pt-2 space-y-2">
                  ...
                  <button
                    ...
                    className="w-full text-center text-xs font-bold text-[var(--neutral-400)] hover:text-black cursor-pointer py-1"
                  >
        ...
        {step === "keepsake-reveal" && keepsake.trim().length > 0 && (
          <section className="chunky-panel bg-[#f5f2eb] p-6 animate-scale-up max-w-2xl mx-auto">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-xs font-black uppercase tracking-wider text-[var(--neutral-500)]">Keepsake Created</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              ...
              <div className="md:col-span-2 flex flex-col items-center justify-center p-4 border-2 border-black/10 rounded-2xl bg-white/70 text-center min-h-[250px] shadow-inner">
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-0 right-0 bg-[#4A6FA5] text-white text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider rotate-12">
                    Keepsake equipped
                  </div>
                </div>
              ...
              <div className="md:col-span-3 flex flex-col justify-between">
                <div className="space-y-4">
                  <div>
                    <span className="text-[10px] font-black uppercase tracking-wider text-[var(--neutral-500)]">Starting Keepsake</span>
                    <h2 className="text-2xl font-black text-[var(--neutral-900)] leading-tight mt-1">
                      {parseKeepsake(keepsake)?.title}
                    </h2>
                    <span className="text-[10px] text-[var(--neutral-500)] font-bold italic">Generated from your description</span>
                  </div>

                  <div className="w-full h-32 rounded-xl border-2 border-dashed border-black/10 bg-white/40 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-xs leading-relaxed text-[var(--neutral-700)] font-medium">
                  ...
                  <div className="space-y-2">
                    <span className="text-[9px] font-black uppercase tracking-wider text-[var(--neutral-500)]">Item Properties</span>
                    <div className="flex flex-wrap gap-1.5">
                      <span className="rounded-md bg-white border border-black/5 px-2 py-0.5 text-[10px] font-bold text-[var(--neutral-700)]">
                        Cosmetic Only
                      </span>
                      <span className="rounded-md bg-white border border-black/5 px-2 py-0.5 text-[10px] font-bold text-[var(--neutral-700)]">
        ...
        {step === "welcome" && (
          <section className="chunky-panel bg-[#f5f2eb] p-8 flex flex-col items-center justify-between text-center min-h-[500px] animate-scale-up">
            <div className="space-y-1">
              <span className="text-xxs font-black uppercase tracking-widest text-[var(--neutral-500)]">Welcome to Cabbits</span>
              <h2 className="text-2xl font-black text-black uppercase tracking-wide">✦ Your Adventure Begins! ✦</h2>
            </div>

            <div className="my-6 flex flex-col items-center">
              <CabbitVectorPreview earStyle={earStyle} eyeStyle={eyeStyle} furColor={furColor} keepsakeText={keepsake} />
              <div className="border-2 border-black/10 bg-white rounded-full px-4 py-1.5 mt-3 text-xxs font-black text-[var(--neutral-900)] uppercase tracking-wider">
                {name || companion?.name || "Pip"} is ready
              </div>
            </div>

            <p className="text-xs leading-6 text-[var(--neutral-700)] max-w-sm font-semibold">
              Your Cabbit is ready. Explore the world, read stories, and discover nature together.
            </p>

            <div className="w-full max-w-xs py-4 border-y border-black/10 my-3 flex flex-col gap-2.5 text-left">
              <div className="flex items-center gap-3 text-xs text-[var(--neutral-700)]">
                <span className="text-green-600 font-bold shrink-0">✓</span>
                <span className="font-bold">Explore Locations</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-[var(--neutral-700)]">
                <span className="text-green-600 font-bold shrink-0">✓</span>
                <span className="font-bold">Read Stories</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-[var(--neutral-700)]">
                <span className="text-green-600 font-bold shrink-0">✓</span>
                <span className="font-bold">Collect Discoveries</span>
              </div>
            </div>
            ...
            <div className="w-full space-y-2 max-w-sm mt-2">
              ...
              <p className="text-[10px] text-[var(--neutral-400)] font-bold">You can customize your Cabbit anytime</p>
            </div>
          </section>
        )}
